...
python3 -m build --outdir scripts/tmp/packages units/adaptyv_nikon
python3 -m build --outdir scripts/tmp/packages units/okolab
python3 -m build --outdir scripts/tmp/packages units/s3
