...
# from runner.util.parser import LocatedError, LocatedValue, Location, Range, Source
...
class LocatedString(str, LocatedValue):
  ...
  def __getitem__(self, key):
    if isinstance(key, slice):
      ...
      return LocatedString(self.value[key], self.location % (start, stop))
    else:
...
#   # raise data['parameters'].error("Hello")
